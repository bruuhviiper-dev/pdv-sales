...
@section('content')
<h5 class="fw-bold mb-4"><i class="ti ti-chart-bar me-2 text-primary"></i>Central de Relatórios</h5>
<div class="row g-3">
    <div class="col-md-6 col-lg-3">
        <a href="{{ route('relatorios.vendas') }}" class="card text-decoration-none text-dark h-100">
            <div class="card-body text-center py-5">
                <i class="ti ti-receipt-2 text-primary" style="font-size:2.5rem"></i>
    ...
    <div class="col-md-6 col-lg-3">
        <a href="{{ route('relatorios.produtos') }}" class="card text-decoration-none text-dark h-100">
            <div class="card-body text-center py-5">
                <i class="ti ti-box text-success" style="font-size:2.5rem"></i>
    ...
    <div class="col-md-6 col-lg-3">
        <a href="{{ route('relatorios.estoque') }}" class="card text-decoration-none text-dark h-100">
            <div class="card-body text-center py-5">
                <i class="ti ti-archive text-info" style="font-size:2.5rem"></i>
